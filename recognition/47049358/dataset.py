...
from monai.transforms import (LoadImaged, EnsureChannelFirstd, ScaleIntensityd,
                               SpatialCropd, RandFlipd, RandRotated, CastToTyped, AsDiscreted,
...
train_images, test_images, train_labels, test_labels = train_test_split(rawImageNames, rawLabelNames, train_size=0.1) # Split the data in training and test set
