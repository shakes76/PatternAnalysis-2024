...
The specific GCN structure in this project is as follows：
  ...
  4.Activation function (ReLU): ReLU activation function is applied after each convolution layer to introduce nonlinearity, so that the model can learn more complex features
...
## References
- Distill. 'A Gentle Introduction to Graph Neural Networks', Accessed 10/27.
