...
"""
Module code for GFNet as implemented in the paper: 
Credit goes to Yongming Rao, Wenliang Zhao, Zheng Zhu, Jiwen Lu, and Jie Zhou

Research Paper URL: https://arxiv.org/abs/2107.00645
GitHub URL: https://github.com/raoyongming/GFNet (called gfnet.py in their code)
"""
class Mlp(nn.Module):
