...
![Training and Validation plots for 16 epochs](/plots/metrics.png)
...
![Confusion matrix for validation data](/plots/confusion_matrix.png)
...
### 4.2.3 ROC Curve
![ROC curve for validation data](/plots/roc.png)
