...
gen_scheduler = optim.lr_scheduler.CosineAnnealingLR(gen_opt, T_max=math.ceil(hp.NUM_OF_EPOCHS*hp.COSINE_ANNEALING_RATE))
disc_scheduler = optim.lr_scheduler.CosineAnnealingLR(disc_opt, T_max=math.ceil(hp.NUM_OF_EPOCHS*hp.COSINE_ANNEALING_RATE))
