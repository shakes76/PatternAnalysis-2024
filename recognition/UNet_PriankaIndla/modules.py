...
class UNet(nn.Module):
    """
    U-Net model used for medical image segmentation which consists of an encoder (contracting path),
    ...
    def __init__(self, in_channels=1, out_channels=1, retainDim=True, outSize=(256, 128)):
        """
        Initialises U-Net model by defining the encoder, bottleneck, and decoder layers.
    ...
    def double_conv(self, in_channels, out_channels):
        """
        Creates a double convolution block with batch normalisation and ReLU activation.
        ...
        Returns:
            nn.Sequential: A sequential of two convolution layers with batch normalisation and ReLU activation.
        """
