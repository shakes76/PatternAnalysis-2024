...
<div style="text-align: center; margin-right: 50px;">
    <h4>Average IoU Received:</h4>
    <p>IoU avg: <strong>0.815</strong></p>
</div>
...
<div style="text-align: center; margin-left: 50px;">
    ...
    <table>
        <thead>
            <tr><th style="padding: 10px;">Metric</th><th style="padding: 10px;">Value</th></tr>
        </thead>
        <tbody>
            <tr><td style="padding: 10px;">Precision</td><td style="padding: 10px;">0.855</td></tr>
            <tr><td style="padding: 10px;">Recall</td><td style="padding: 10px;">0.873</td></tr>
        </tbody>
    </table>
</div>
...
![Test Predictions](https://github.com/mraula/PatternAnalysis-2024/blob/topic-recognition/recognition/YOLOs4703527/figures/test_pred.png)
