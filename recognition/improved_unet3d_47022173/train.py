"""
This file contains the code to train the 3D U-Net model on the training set, validate on the 
validation set and test on the test set. The training loops contains validation and saving of 
the model every few epochs. A final trained version of the model is saved at the end of training.
