"""
Contains functions used in modules, train, predict, and dataset files.
...
def batch_ssim(generated, real):
    """
    Calculates the SSIM score of a given batch of images

    Parameters:
        generated: Images generated by the model
        real: Corresponding real images
    """
    ssim_values = []
