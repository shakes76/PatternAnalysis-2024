...
def train(patience=50, lr=1e-4, batch_size=64, show_plots=False, 
    ...
    if show_plots:
        ...
        # add mark where early stopping was triggered
        plt.axvline(x=epoch-epochs_no_improve, color='r', linestyle='--', label='Early Stopping')
...
def main():
    ...
    for lr, batch_size, weight_decay in param_combinations:
        ...
        if not os.path.exists(model_path):
            ...
            print(f"Model with parameters lr={lr}, batch_size={batch_size}, weight_decay={weight_decay} already trained.")
